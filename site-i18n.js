...
var SITE_I18N = {
  es: {
    ...
    privacidad_s1_p1: "Estos datos se guardan en una base de datos (Firebase, de Google) asociados a un identificador anónimo que se genera en tu navegador, no a tu identidad real. Las salas y sus datos no están pensados para conservarse indefinidamente. Si jugás el desafío del día o el contrarreloj, tu nombre de jugador, tu fruta y tu puntaje aparecen en los rankings públicos de ese día o de esa semana.",
    privacidad_s1_sub2_heading: "Datos guardados en tu dispositivo",
    privacidad_s1_sub2_p: "Usamos el almacenamiento local del navegador (localStorage) para recordar, únicamente en tu propio dispositivo, tu nombre de jugador, tu fruta, el tema de color, si preferís el sonido silenciado, y tus estadísticas y logros. Esta información no se envía a nuestros servidores ni a terceros.",
  ...
  en: {
    ...
    privacidad_s1_sub2_p: "We use your browser's local storage (localStorage) to remember, only on your own device, your player name, your fruit, your color theme, whether you prefer sound muted, and your stats and achievements. This information is never sent to our servers or to third parties.",
  ...
  pt: {
    ...
    privacidad_s1_sub2_p: "Usamos o armazenamento local do navegador (localStorage) para lembrar, somente no seu próprio dispositivo, seu nome de jogador, sua fruta, o tema de cores, se você prefere o som silenciado, e suas estatísticas e conquistas. Essa informação nunca é enviada aos nossos servidores nem a terceiros.",
