...
var SITE_I18N = {
  es: {
    ...
    reglas_s1_li3_html: '<strong>Sala al azar:</strong> te empareja con quien esté buscando partida en ese momento, con categorías y reglas fijas. Si nadie aparece en unos segundos, podés seguir esperando o jugar contra un rival de prueba.',
    ...
    privacidad_s3_p: "No vendemos datos personales. Compartimos información únicamente con los proveedores necesarios para que el Sitio funcione: Firebase (Google) para la sincronización de salas en tiempo real, Anthropic para el juez con inteligencia artificial, y Google AdSense para la publicidad, cada uno sujeto a sus propias políticas de privacidad.",
  ...
  en: {
    ...
    reglas_s1_li3_html: '<strong>Random room:</strong> matches you with whoever is looking for a game right now, with fixed categories and rules. If no one shows up in a few seconds, you can keep waiting or play against a test opponent.',
    ...
    privacidad_s3_p: "We don't sell personal data. We share information only with the providers needed for the Site to work: Firebase (Google) for real-time room syncing, Anthropic for the AI judge, and Google AdSense for advertising, each subject to their own privacy policies.",
  ...
  pt: {
    ...
    reglas_s1_li3_html: '<strong>Sala aleatória:</strong> você é pareado com quem estiver procurando partida nesse momento, com categorias e regras fixas. Se ninguém aparecer em alguns segundos, você pode continuar esperando ou jogar contra um adversário de teste.',
    ...
    privacidad_s3_p: "Não vendemos dados pessoais. Compartilhamos informações apenas com os provedores necessários para o Site funcionar: Firebase (Google) para a sincronização de salas em tempo real, Anthropic para o juiz com inteligência artificial, e Google AdSense para a publicidade, cada um sujeito às suas próprias políticas de privacidade.",
